namespace EnglishMaster.Contracts.ContentQuality;
...
public sealed record CreateContentQualityRuleRequest(
    string Code,
    string Name,
    string? Description,
    string ContentType,
...
public sealed record UpdateContentQualityRuleRequest(
    string Code,
    string Name,
    string? Description,
    string ContentType,
...
public sealed record RunContentQualityCheckRequest(
    string ContentType,
    Guid ContentId);
