namespace EnglishMaster.Contracts.Achievements;
...
public sealed record AchievementDefinitionRequest(string Code, string Name, string? Description, string AchievementType, int TargetValue, string? IconName, int SortOrder);
