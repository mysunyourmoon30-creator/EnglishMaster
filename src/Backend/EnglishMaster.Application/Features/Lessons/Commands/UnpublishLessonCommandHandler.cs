...
public sealed class UnpublishLessonCommandHandler
{
    ...
    public UnpublishLessonCommandHandler(
    ...
    public async Task<Result<LessonDto>> HandleAsync(
        UnpublishLessonCommand command,
        CancellationToken cancellationToken)
    {
        ...
        lesson.Unpublish(timeProvider.GetUtcNow());
