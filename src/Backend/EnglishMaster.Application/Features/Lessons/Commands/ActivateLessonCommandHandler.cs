...
public sealed class ActivateLessonCommandHandler
{
    ...
    public ActivateLessonCommandHandler(
        ...
        CancellationToken cancellationToken)
    {
        ...
        lesson.Activate(timeProvider.GetUtcNow());
