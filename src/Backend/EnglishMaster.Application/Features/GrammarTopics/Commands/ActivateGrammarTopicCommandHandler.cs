...
public sealed class ActivateGrammarTopicCommandHandler
{
    private readonly IGrammarTopicRepository grammarTopicRepository;
    private readonly TimeProvider timeProvider;

    public ActivateGrammarTopicCommandHandler(
    ...
    public async Task<Result<GrammarTopicDto>> HandleAsync(
        ActivateGrammarTopicCommand command,
        CancellationToken cancellationToken)
    {
        ...
        grammarTopic.Activate(timeProvider.GetUtcNow());
