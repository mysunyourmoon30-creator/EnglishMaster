...
using EnglishMaster.Web.Services.StudentProgress;
...
builder.Services.AddScoped<IStudentProgressApiClient, StudentProgressApiClient>();
...
builder.Services.AddScoped<IDiagnosticApiClient, DiagnosticApiClient>();
